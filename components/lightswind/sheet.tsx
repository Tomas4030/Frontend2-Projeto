...
const SheetTrigger = React.forwardRef<HTMLButtonElement, SheetTriggerProps>(
  ({ children, asChild, ...props }, forwardedRef) => {
    ...
    const childRef =
      child && React.isValidElement(child) ? (child as any).ref : undefined;
          ...
          <SheetPortal>
            ...
            <motion.div
              ...
              className={cn(
                ...
                side === "left" &&
                  "inset-y-0 left-0 h-full w-3/4 border-r border-gray-200 dark:border-gray-800/40  sm:max-w-sm",
                side === "right" &&
                  "inset-y-0 right-0 h-full w-3/4 border-l border-gray-200 dark:border-gray-800/40  sm:max-w-sm",
                className,
              )}
              {...restProps}
            >
